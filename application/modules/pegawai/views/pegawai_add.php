...
<div class="container-fluid">
  ...
  <div class="row-fluid">
  <div class="span12">
   <form action="<?php echo base_url('pegawai/pro_add');?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="collapse in accordion-body" id="collapseGOne">
              ...
              <!--content here-->
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="nrp" class="span11" />
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label">Nama :</label>
                    <div class="controls">
                    <input type="text" name="nm_pegawai"  class="span11" />
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label">No Telp :</label>
                    <div class="controls">
                    <input type="text" name="no_telp"  class="span11" />
                    </div>
                  </div>
                  <div class="control-group">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                    <textarea name="alamat" id="alamat" class="span11"></textarea>
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label">Seksi :</label>
                    <div class="controls">
                      <input type="text" name="seksi" class="span11"  />
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <option value="">--</option>
                      <?php
                      foreach ($opt_kas_for->result() as $valkas) {
                      ?>
                      <option value="<?php echo $valkas->id;?> "> <?php echo $valkas->nm_pegawai;?> </option>
                      <?php
                      }
                      ?>
                    </select>
                  ...
                  <div class="control-group">
                    ...
                    <select name="opt_foreman" id="opt_foreman">
                      <option value="">--</option>
                      <?php
                      foreach ($opt_kas_for->result() as $valfor) {
                      ?>
                      <option value="<?php echo $valfor->id;?> "> <?php echo $valfor->nm_pegawai;?> </option>
                      <?php
                      }
                      ?>
                    </select>
