...
<div class="panel panel-midnightblue">
    ...
    <div class="panel-body collapse in">
        <form action="<?php echo base_url('barang/pro_edit'); ?>" class="form-horizontal row-border" method="POST">
        <input type="hidden" name="id" value="<?php echo $listing->id?>">
            <div class="form-group">
                <label class="col-sm-3 control-label">Part Number</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" value="<?php echo $listing->part_number;?>" name="part_number">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">Nama Barang</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="nama" value="<?php echo $listing->nama;?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                  <select class="form-control" id="source" name="id_gudang">
                        ...
                        foreach ($opt_gudang->result() as $rowopt) {	
                            if($listing->id_gudang == $rowopt->id){
