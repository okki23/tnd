...
<div class="container-fluid">
  ...
  <div class="row-fluid">
  <div class="span12">
   <form action="<?php echo base_url('user/pro_add');?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              ...
              <!--content here-->
                ...
                <div class="widget-content nopadding">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                   <input type="text" name="username" id="username"   class="span11" />
                   ...
                   <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      ?>
                      <option value="<?php echo $val->id;?> "> <?php echo $val->nm_pegawai;?> </option>
                      <?php
                      }
                      ?>
