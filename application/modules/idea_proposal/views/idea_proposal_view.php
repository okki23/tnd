      ...
      <div class="span12">
        ...
        <!-- | No Register | NRP | Nama | Opsi -->
          ...
          <div class="widget-content nopadding">
            ...
            ?>
              <h3 align='center'> LISTING DATA FOREMAN (BAWAHAN) </h3>
              ...
              ?>
                <tr class="gradeX">
                  ...
                  <td> <?php echo $rows->nm_pegawai; ?> </td>
                  <td class="center"> <a href="<?php echo base_url('idea_proposal/get_bawahan_foreman/'.$rows->id); ?>"> Detail </a>
                  </td>
           ...
           ?>
              ...
              $get_kasie_name = $this->model_idea_proposal->get_kasie_name();
 
              $get_foreman_name = $this->load->model('model_idea_proposal');*/
              ?>
              ...
              ?>
                <tr class="gradeX">
                  ...
                  <td> <?php echo $rows->nm_kasie; ?> </td>
                  <td> <?php echo $rows->komentar_aprove_kasie; ?> </td>
                  <td> <?php echo $rows->nm_foreman; ?> </td>
                  <?php
                  if($_SESSION['level'] != 'karyawan'){
                  ?>

                  <td class="center"> <a href="<?php echo base_url('idea_proposal/detail/'.$rows->id); ?>"> Detail </a> &nbsp; | &nbsp;
                      <a href="<?php echo base_url('idea_proposal/cetak/'.$rows->id); ?>"> Print </a>
                  </td>
