              ...
              <!--content here-->
                ...
                <div class="widget-content nopadding">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="opt_nama" value="<?php echo $getname->nm_pegawai; ?>" class="span11" readonly="readonly">
                   
                   <input type="hidden" class="span11" name="nama" value="<?php echo $getname->nm_pegawai; ?>" id="hid_opt_nama" />
                   
                    <input type="hidden" class="span11" name="id_pegawai" value="<?php echo $getname->id; ?>" />
                    </div>
                  </div>
                   <div class="control-group">
                    <label class="control-label">NRP :</label>
                    <div class="controls">
                        <input type="text" name="nrp" id="nrp" readonly="readonly" value="<?php echo $getname->nrp; ?>"  class="span11" />
                    </div>
                  </div>
                   <div class="control-group">
                    <label class="control-label">Seksi :</label>
                    <div class="controls">
                      <input type="text" name="seksi" id="seksi" readonly="readonly" value="<?php echo $getname->seksi; ?>"   class="span11"  />
                    </div>
                  </div>
                   <div class="control-group">
                    <label class="control-label">Risalah:</label>
                    <div class="controls">
                      <input type="text" name="risalah" id="risalah" class="span11"  />
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label">Tanggal:</label>
                    <div class="controls">
                        <input type="text" name="tanggal"  id="tanggal" value="<?php echo date('Y-m-d');?>" readonly="readonly" class="span11"  />
                    </div>
                  </div>
              ...
              <!--content here-->
                ...
                <div class="widget-content nopadding">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" class="span11" name="no_reg" value="<?php echo "REG".$lastid;?>" readonly="readonly" />
              ...
              <div class="widget-content"> 
                 ...
                 <div class="widget-content nopadding">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="text" name="tema_ip"  class="span12"   />
                      </div>
                    </div>
              ...
              <div class="widget-content span12"> 
                  ...
                  <div class="widget-content nopadding span6">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                       <textarea class="span11" name="ksp" ></textarea>
                       <br>
                       <br>
                       <span class="label label-important"> JPEG,JPG,PNG,GIF (Max 1000 Kb) </span>
                       <input type="file" name="upload_ksp" id="upload_ksp" class="form-control" >
                       <input type="hidden" name="fupload_ksp" id="fupload_ksp" class="form-control" >
                       <div id="imgksp"></div>
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <textarea class="span11" name="akibat" ></textarea>
                      </div>
                    </div>
                  ...
                  <div class="widget-content nopadding span6">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                       <textarea class="span11" name="kstp" ></textarea>
                       <br>
                       <br>
                       <span class="label label-important"> JPEG,JPG,PNG,GIF (Max 1000 Kb) </span>
                       <input type="file" name="upload_kstp" id="upload_kstp" class="form-control" >
                       <input type="hidden" name="fupload_kstp" id="fupload_kstp" class="form-control" >
                       <div id="imgkstp"></div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <textarea class="span11" name="standarisasi" ></textarea>
                       <br>
                       <br>
                       <span class="label label-important"> JPEG,JPG,PNG,GIF (Max 1000 Kb) </span>
                       <input type="file" name="upload_standarisasi" id="upload_standarisasi" class="form-control" >
                       <input type="hidden" name="fupload_standarisasi" id="fupload_standarisasi" class="form-control" >
                       <div id="imgstd"></div>
              ...
              <div class="widget-content"> 
                 ...
                 <div class="widget-content nopadding">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <textarea class="span11" name="manfaat" ></textarea>
